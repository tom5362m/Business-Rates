...
raw_data<-load_data("Data/Raven Suite - AK - 13091186000.xlsx",NULL)
...
address_edge_creation<-function(address_data){
  ...
  filter(change_reason=="ADDRESS CHANGE & REVIEW OF ASSESSMENT")|>#creating the data set for address changes
